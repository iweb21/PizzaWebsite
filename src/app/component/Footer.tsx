      ...
      <div>
        <footer className='flex flex-col space-y-10 justify-center m-10 mb-0'>
          <nav className='flex justify-center flex-wrap gap-6 text-slate-500 font-medium bg-gradient-to-r from-black'>
                ...
                <a className='text-white hover:text-gray-400'  href='#'>Delievery</a>
             
                <a  className='text-white hover:text-gray-400'  href='#'>Contact</a>
              
                <a  className='text-white hover:text-gray-400'  href='#'>Terms & Conditions</a>
              
                <a  className='text-white hover:text-gray-400'  href='#'>Privacy Policy</a>
          ...
          <div className='flex justify-center space-x-5 transition-transform duration-500 ease-in-out transform hover:scale-105'>
            ...
            <img src="https://img.icons8.com/?size=100&id=xuvGCOXi8Wyg&format=png&color=000000" alt="linkedin logo" />
             </a>
