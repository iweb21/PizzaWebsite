...
const Products = [
  {
    ...
    category: "fixing",
    price: "300.00",
    imageUrl: "https://media.giphy.com/media/gxLbfh5DvhspW/giphy.gif",
    bgcolor: "bg-amber-500",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    category: "fixing",
    price: "380.00",
    imageUrl: "https://media.giphy.com/media/LZhjYok6EnDCE/giphy.gif",
    bgcolor: "bg-amber-500",
  },
];
        ...
        >
          ...
          <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
            <div
              className="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3"
              style={{
                background: "radial-gradient(circle, rgba(0,0,0,0.2), transparent 50%)",
                transform: "rotate3d(0, 0, 1, 20deg) scale(1, 0.6)",
              }}
            ></div>
            ...
            <Image
              ...
              width={200}
              height={300}
              className="object-cover w-full h-56 rounded-md mb-4 transform transition-all duration-300 ease-in-out group-hover:scale-110"
            />
          </div>
          ...
          <div className="relative text-white px-6 pb-6 mt-6">
            ...
            <div className="flex justify-between">
              <span className="block font-serif text-xl">{product.title}</span>
              <span className="block bg-white rounded-full text-orange-500 text-xs font-bold px-3 py-2 leading-none items-center">
                ${product.price}
              </span>
            </div>
